...
const userActivitySchema = new mongoose.Schema(
  {
    ...
    type: {
      ...
      enum: [
        ...
        "daily_goal_completed", "badge_earned", "schedule_created", "challenge_reward",
      ],
    },
    title: { type: String, required: true, trim: true, maxlength: 160 },
    description: { type: String, trim: true, maxlength: 300, default: "" },
    relatedEntityType: { type: String, enum: ["interview", "resume", "badge", "schedule", "challenge", null], default: null },
